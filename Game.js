class Game {
  ...
  {
    debugger;
    image(fuel,player.positionX-180,height-player.positionY-200,20,20);
    push();
    fill('white');
    rect(player.positionX-150,height-player.positionY-200,185,20);
    fill('green');
    rect(player.positionX-150,height-player.positionY-200,player.fuel,20);
    pop();
